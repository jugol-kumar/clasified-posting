...
const showItem = (id, type) =>{
    ...
    axios.get(`${props.main_url}/${id}`).then((res) =>{
        ...
        updateForm.title = res.data.name;
...
const updateItem = () =>{
    ...
    updateForm.post(`/panel/admin/sub-category/update/${updateForm.id}`,{
        preserveState: true,
        replace: true,
        onSuccess: page => {
                ...
                <div class="modal-body flex-grow-1">
                    <form @submit.prevent="addItem">
                        ...
                        <div class="mb-1">
                            ...
                            <v-select :options="props.parent_categories"
                    ...
                    <form @submit.prevent="updateItem">
                        ...
                        <div class="mb-1">
                            ...
                            <v-select :options="props.parent_categories"
                                      ...
                                      class="form-control"
                                      label="name" :reduce="category => category.id"
